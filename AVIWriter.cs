...
public class AviWriter {
  ...
  private void CreateStream() {
    AVISTREAMINFOW strhdr           = new AVISTREAMINFOW();
       ...
       strhdr.rect_top              = 0;   //JMW, prev 0 ???
       strhdr.rect_left             = 0;
       strhdr.rect_bottom           = height_;         //JMW, prev height_  ???
  ...
  unsafe private void SetOptions() {
      AVICOMPRESSOPTIONS opts = new AVICOMPRESSOPTIONS();
       ...
       opts.lpFormat          = (IntPtr) 0; //new IntPtr(0);
       opts.cbFormat          = 0;
       opts.lpParms           = (IntPtr) 0; //new IntPtr(0);
       opts.cbParms           = 0;
