namespace Vs.Encoder.AviLib
{
    ...
    public class AVIWriter : IDisposable
    {
        ...
        // Create new AVI file
        public void Open(string fname, int frate, int width, int height)
        {
            Win32.AVIFileInit();
            ...
            // create new file
            int res = Win32.AVIFileOpen(out file, fname, Win32.OpenFileMode.Create | Win32.OpenFileMode.Write, IntPtr.Zero);
            if (res != 0) throw new ApplicationException("Failed opening file : " + fname);
